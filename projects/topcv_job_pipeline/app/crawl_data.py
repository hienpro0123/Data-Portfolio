...
# ------------ Pipeline ------------
def crawl_to_list(query_url_template: str, start_page: int = 1, end_page: int = 1,
                 delay_between_pages=(8, 15)) -> List[Dict]:
    """
    Crawl dữ liệu và trả về kết quả dưới dạng list of dictionaries
    Phù hợp để sử dụng với Airflow
    """
    rows: List[Dict] = []
    seen_jobs = set()
        ...
        for j in jobs:
            ...
            try:
                ...
                detail = {k: None for k in [
                    "deadline", "tags", "desc_mota", "desc_yeucau", 
                    "desc_quyenloi", "working_addresses", "working_times", 
            ...
            # Gộp tất cả dữ liệu và đổi tên cột
            row = {
                # Từ search page
                "Title": j["title"],
                "Job URL": j["job_url"],
                ...
                "Salary (Triệu VND)": j["salary_list"],
                "Address": j["address_list"],
                "Experience": j["exp_list"],
                
                # Từ job detail
                "Deadline": detail["deadline"],
                "Tags": detail["tags"],
                "Detail Address": detail["working_addresses"],
                "Working Times": detail["working_times"],
                "Job_Description": detail["desc_mota"],
                "Requirements": detail["desc_yeucau"],
                "Benefits": detail["desc_quyenloi"],
